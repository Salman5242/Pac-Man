...
Maze::Maze() : tiles{			{30, 30, 30,  0, 13, 13, 13, 13, 13, 13, 13, 13,  1, 30, 30, 30,  8, 30,  9, 30, 30, 30,  0, 13, 13, 13, 13, 17, 28, 13, 13, 13, 13,  1, 30, 30},
...
int Maze::getTileCode(int x, int y)
{
	return tiles[x][y];
}

bool Maze::tile_Blocks_Entity(int x, int y)
{
...
void Maze::removeDot(PacMan* pacman, Ghost* ghost1, Ghost* ghost2, Ghost* ghost3, Ghost* ghost4)
{
	if (tiles[pacman->XTile_getter()][pacman->YTile_getter()] == 26)
	{
		tiles[pacman->XTile_getter()][pacman->YTile_getter()] = 30;
		pacman->eatDot();
	}
	else if (tiles[pacman->XTile_getter()][pacman->YTile_getter()] == 27)
	{
		tiles[pacman->XTile_getter()][pacman->YTile_getter()] = 30;
		ghost1->Frightened_setter(true);
		ghost2->Frightened_setter(true);
		ghost3->Frightened_setter(true);
		ghost4->Frightened_setter(true);
	}
}